...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>👋 Hello {mention}✨ /n/nI can store private files in Specified Channel and other users can access it from special link. \n🌿 ᴍᴀɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/Vishalku25">Vishal Kumar</a></b>")
try:
    ADMINS=[]
