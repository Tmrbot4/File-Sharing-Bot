...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>👋 Hello {mention}✨ /n I can store private files in Specified Channel and other users can access it from special link.</b>")
try:
    ADMINS=[]
